...
public class Usuarios {
    ...
    public Usuarios(int id, String nombre, String apellido, String documento, 
            String email, String telefono, String usuario, String password, 
            int tipoDocumentoId, int proyectoId, int rolId) {
        this.id = id;
        this.nombre = nombre;
    ...
    public String toString() {
        return "ID: " + id + ", Nombre: " + nombre + ", Apellido: " + apellido 
                ...
                + telefono +", Usuario: " + usuario + ", Contraseña: " + password; 
    }
}
