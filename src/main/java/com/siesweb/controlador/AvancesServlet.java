...
public class AvancesServlet extends HttpServlet {
	...
	protected void insertarAvc(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		try {
			...
			if (proy != null) {
				avancesDAO.insertarAvc(new Avances(0, fecha, tramo_amp,
				        tramo_mej, tramo_sub, tramo_bas, tramo_asf, cunetas,
				        muros, ejecucion, proy.getId()));
	...
	private void actualizarAvc(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        if (!idString.isEmpty()) {
            ...
            try {
    			...
    			if (proy != null) {
    				avancesDAO.actualizarAvc(new Avances(id, fecha, tramo_amp,
    				        tramo_mej, tramo_sub, tramo_bas, tramo_asf, cunetas,
    				        muros, ejecucion, proy.getId()));
	...
	private void buscarAvc(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
	...
	private void eliminarAvc(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
	...
	private void listarAvc(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		try {
