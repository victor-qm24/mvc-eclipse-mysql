        		...
        		<form method="POST" action="insertarTema">
	                ...
	                <div class="formulario__grupo" id="grupo__descTema">                                
	                    <div class="formulario__grupo-input d-flex">
	                        <input type="text" name="descTema" id="descTema" class=" form-control formulario__input mb-2" placeholder="Descripcion" oninput="validarDescTema()">
	                        <i class="formulario__validacion-estado material-icons ms-1" id="iconDescTema">check_circle</i>
	                    </div>
        			...
        			<div class="row">
        				<div class="col-sm-3">
                            ...
                            <div class="formulario__grupo" id="grupo__id">                                
                                <div class="formulario__grupo-input d-flex">
                                    <input type="text" name="idTema" id="idTema" class=" form-control formulario__input mb-2" placeholder="Id" oninput="validarIdTema()">
                                    <i class="formulario__validacion-estado material-icons ms-1" id="iconIdTema">check_circle</i>
                                </div>
        				...
        				<div class="col-sm-9">
			                ...
			                <div class="formulario__grupo" id="grupo__descripcionTema">                                
			                    <div class="formulario__grupo-input d-flex">
			                        <input type="text" name="descripcionTema" id="descripcionTema" class=" form-control formulario__input mb-2" placeholder="Descripcion" oninput="validarDescripcionTema()">
			                        <i class="formulario__validacion-estado material-icons ms-1" id="iconDescripcionTema">check_circle</i>
			                    </div>
        		...
        		<form action="eliminarTema" method="POST">
        			<div class="row">        			
        				...
        				<div class="col-sm-3">
			                ...
			                <div class="formulario__grupo" id="grupo__id">                                
			                    <div class="formulario__grupo-input d-flex">
			                        <input type="text" name="idTemas" id="idTemas" class=" form-control formulario__input mb-2" placeholder="Id" oninput="validarIdTemas()">
			                        <i class="formulario__validacion-estado material-icons ms-1" id="iconIdTemas">check_circle</i>
			                    </div>
