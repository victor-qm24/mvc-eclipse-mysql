        ...
        <div class="row mt-3">
            <div class="col-sm-8 bg-dark-subtle pt-3 rounded">
                <div class="row pt-3">
		            ...
		            <div class="col-sm-4">
		            	<form action="inactivar" method="POST" class="formulario" id="formulario" onsubmit="return validarFormulario();">
		                    <div class="row">                    	
			        			<div class="col-sm-6">
			        				<!--grupo__id-->
		                            <div class="formulario__grupo" id="grupo__id">                                
		                                <div class="formulario__grupo-input d-flex">
		                                    <input type="text" name="idInactivar" id="idInactivar" class=" form-control formulario__input" placeholder="Id" oninput="validarIdInactivar()">
		                                    <i class="formulario__validacion-estado material-icons ms-1" id="iconIdInactivar">check_circle</i>
		                                </div>
		                                <p class="formulario__input-error" id="idInactivarError"></p>
		                            </div>
			        			</div> 
			        			<div class="col-sm-6">
			        				<input type="submit" value="Inactivar" class="btn btn-warning float-start formulario__btn">	        					        				
			        			</div>
		                    </div> 		                               
		                </form>
		            </div>      		
