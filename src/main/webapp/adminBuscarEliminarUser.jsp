...
<body>
	...
	<section class="container-fluid bg-body p-5 pt-1"
		...
		<div class="row mt-3">
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<input type="submit" value="Buscar"
										class="btn btn-success formulario__btn">
								</div>
							</div>
						</form>
					</div>
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<input type="submit" value="Eliminar"
										class="btn btn-danger float-start formulario__btn">
								</div>
							</div>
						</form>
					</div>
						...
						<form action="inactivar" method="POST" class="formulario"
							...
							<div class="row">
								<div class="col-sm-6">
									...
									<div class="formulario__grupo" id="grupo__id">
										<div class="formulario__grupo-input d-flex">
											<input type="text" name="idInactivar" id="idInactivar"
												class=" form-control formulario__input" placeholder="Id"
								...
								<div class="col-sm-6">
									<input type="submit" value="Inactivar"
										class="btn btn-warning float-start formulario__btn">
								</div>
							</div>
						</form>
					</div>
			...
			<div class="col-sm-4">
				<img src="imagenes/asfaltado-2.jpg" alt=""
