...
<body>
	<nav class="navbar navbar-expand-sm fixed-top bg-light">
        <div class="container-fluid">
        	...
        	<ul class="nav nav-pills justify-content-end">        		 
                ...
                <li class="nav-item"><a class="nav-link" href="#sec-estadisticas">Estadisticas</a></li>               
       			<li class="nav-item"><a class="nav-link" href="#sec-solicitudes">Solicitudes</a></li>       			              
            </ul>
        </div>
    </nav>
    <section class="container-fluid p-3" style="margin-top: 100px;" id="sec-inicio">
        <% 
        ...
        <div class="row mt-4">
            ...
            <div class="col-sm-6">
                <img src="imagenes/vias-3.jpg" alt="" srcset="" class="d-block w-100">
            </div>
        </div>
    </section>
    <section class="container-fluid bg-light p-5 pt-1" style="margin-top: 100px;" id="sec-estadisticas">
        <h1><b>Pavimentación Palmitas - Lerma</b></h1>
        <h6>Avances estadisticos</h6>
        <div class="row border bordered mt-5">
            <div class="col-sm-2 border-2 border-dark border-end d-block text-center p-3">
            	<h3 class="text-primary"><strong>1000 m</strong></h3>
    ...
    <section class="container-fluid p-5" id="sec-solicitudes">
        <h1><b>Solicitudes</b></h1><br>
        <div class="row">
            <div class="col-sm-6">
                <form action="#" class="d-block bg-dark-subtle rounded p-3 h-100 formulario" id="formulario">
                    <!--grupo__nombres-->
                    <div class="formulario__grupo" id="grupo__nombres">
                        ...
                        <div class="formulario__grupo-input d-flex">
                            <input type="text" name="nombres" id="nombres" class="formulario__input form-control" placeholder="Ingrese su nombre...">
                            <i class="formulario__validacion-estado material-icons ms-1">check_circle</i>
                        </div>
                        <p class="formulario__input-error d-none">El nombre solo permite letras.</p>
                    </div>
                    <!--grupo__proyecto-->
                    <div class="formulario__grupo" id="grupo__proyecto">
                        <label for="proyecto" class="form-label formulario__label">Proyecto</label>                                
                        <div class="formulario__grupo-input d-flex">
                            <select name="proyecto" id="proyecto" class="form-select formulario__input mb-2">
                                <option value="-">-</option>
                                <option value="Pavimentacion PALMITAS-LERMA">Pavimentacion PALMITAS-LERMA</option>                                        
                            </select>
                            <i class="formulario__validacion-estado material-icons ms-1">check_circle</i>
                        </div>
                        <p class="formulario__input-error d-none">Se debe especificar el proyecto de interes.</p>
                    </div>
                    <!--grupo__tema-->
                    <div class="formulario__grupo" id="grupo__tema">
                        <label for="tema" class="form-label formulario__label"><b>Tema</b></label>                                
                        <div class="formulario__grupo-input d-flex">
                            <select name="tema" id="tema" class="form-select formulario__input">
                                <option value="-">-</option>
                        ...
                        <p class="formulario__input-error d-none">Se debe especificar el tema.</p>
                    </div>
                    <!--grupo__observacion-->
                    <div class="formulario__grupo" id="grupo__observacion">
                        ...
                        <div class="formulario__grupo-input d-flex">
                            <input type="text" name="observacion" id="observacion" class=" form-control formulario__input mb-2" placeholder="Ingrese su observacion...">
                            <a href="#" class="form-text ms-1">Adjuntar</a>
                            <i class="formulario__validacion-estado material-icons ms-1">check_circle</i>                            
                        </div>
                        <p class="formulario__input-error d-none"></p>
                    </div>
                    <!--Mensaje-exito-error-->                            
                    <div class="formulario__mensaje border rounded bg-danger ps-2 pe-2 lh-1 d-none mt-2" id="formulario__mensaje">
                        <p><i class="material-icons me-2">assignment_late</i><b>Error: </b>Por favor rellena el formulario correctamente.</p>
                    </div>
                    <div class="formulario__grupo formulario__grupo-btn-enviar mb-5 mt-2">                                               
                        <input type="submit" value="Enviar" class="btn btn-primary float-end formulario__btn">
                        <p class="formulario__mensaje-exito text-success d-none" id="formulario__mensaje-exito">Envio exitoso!</p>
                    </div>                               
                </form>
            </div>
            <div class="col-sm-6">
