    ...
    <section class="container-fluid bg-body p-5 pt-1" style="margin-top: 100px;">
        ...
        <div class="row mt-3">
            <div class="col-sm-6 bg-dark-subtle p-3 rounded">
                <form action="insertar" method="POST" class="formulario" id="formulario" onsubmit="return validarFormulario();">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <!--grupo__nombre-->
            ...
            <div class="col-sm-6">
                <img src="imagenes/asfaltado.jpg" alt="" class="img-fluid p-2 w-100 rounded">
            </div>
        </div>
    </section>
